...
-- 6. Members
INSERT INTO "community_members" ("id", "community_id", "user_id", "admin", "created_at") VALUES
('60000000-0000-4000-8000-000000000001', '40000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', true, NOW() - INTERVAL '60 days'), -- Juan is admin of Green Earth
('60000000-0000-4000-8000-000000000002', '40000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000002', false, NOW() - INTERVAL '55 days'), -- Maria is member of Green Earth
('60000000-0000-4000-8000-000000000003', '40000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000003', true, NOW() - INTERVAL '50 days'), -- Carlos is admin of Animal Rescue
('60000000-0000-4000-8000-000000000004', '40000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000006', true, NOW() - INTERVAL '45 days'), -- Elena is admin of Tech for Good
('60000000-0000-4000-8000-000000000005', '40000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000007', false, NOW() - INTERVAL '40 days'), -- David is member of Tech for Good
('60000000-0000-4000-8000-000000000006', '40000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000009', true, NOW() - INTERVAL '35 days'), -- Miguel is admin of Local Food Bank
('60000000-0000-4000-8000-000000000007', '40000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000001', false, NOW() - INTERVAL '34 days'), -- Juan joins Animal Rescue
('60000000-0000-4000-8000-000000000008', '40000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000001', false, NOW() - INTERVAL '33 days'), -- Juan joins Tech for Good
('60000000-0000-4000-8000-000000000009', '40000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000002', false, NOW() - INTERVAL '32 days'), -- Maria joins Animal Rescue
('60000000-0000-4000-8000-000000000010', '40000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000002', false, NOW() - INTERVAL '31 days'), -- Maria joins Local Food Bank
('60000000-0000-4000-8000-000000000011', '40000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000003', false, NOW() - INTERVAL '30 days'), -- Carlos joins Green Earth
('60000000-0000-4000-8000-000000000012', '40000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000003', false, NOW() - INTERVAL '29 days'), -- Carlos joins Tech for Good
('60000000-0000-4000-8000-000000000013', '40000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000004', false, NOW() - INTERVAL '28 days'), -- Ana joins Green Earth
('60000000-0000-4000-8000-000000000014', '40000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000004', false, NOW() - INTERVAL '27 days'); -- Ana joins Animal Rescue
...
-- 9. Cause Supports
INSERT INTO "cause_supports" ("id", "cause_id", "user_id", "anonymous_user_id", "created_at") VALUES
('90000000-0000-4000-8000-000000000001', '80000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000002', NULL, NOW() - INTERVAL '20 days'), -- Maria supports Reforest the Park
('90000000-0000-4000-8000-000000000002', '80000000-0000-4000-8000-000000000006', NULL, '30000000-0000-4000-8000-000000000001', NOW() - INTERVAL '12 days'), -- Anonymous supports Flood Relief
('90000000-0000-4000-8000-000000000003', '80000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000001', NULL, NOW() - INTERVAL '8 days'); -- Juan supports Beach Cleanup
